  ...
  return (
    <section id="hero" className="relative" ref={heroRef} dir={dir}>
      <div className="min-h-screen w-full bg-[var(--background)] overflow-hidden flex items-center justify-center">
        ...
        {/* Left Image - Eggplant - Adjust position for RTL */}
        <motion.div
          style={{ y: leftImageY }}
        ...
        {/* Right Image - USB - Adjust position for RTL */}
        <motion.div
          style={{ y: lampY }}
          variants={imageVariants}
          initial="hidden"
        ...
        <div className="flex flex-col items-center gap-4 z-10 relative px-4 text-center max-w-4xl mx-auto w-full mb-32">
          {/* Title - Unified approach for all languages */}
          <motion.h1
          ...
          >
            {isArabic ? (
              // For Arabic, render as single block without character animation
              <motion.span variants={charVariants}>{titleText}</motion.span>
            ) : (
              // For other languages, use character stagger animation
...
//   // Different variants for Arabic vs other languages
//   const titleVariantsArabic = {
//     hidden: { y: -80, opacity: 0 },
//     visible: {
//       y: 0,
//       opacity: 1,
...
//         <div className="flex flex-col items-center gap-4 z-10 relative px-4 text-center max-w-4xl mx-auto w-full mb-32">
//           {/* Title - Different animation for Arabic vs other languages */}
//           {isArabic ? (
//             <motion.h1
//               className="text-[var(--primary)] text-7xl md:text-[13vw] lg:text-[8vw] mb-12"
//               variants={titleVariantsArabic}
//               initial="hidden"
//               animate="visible"
//             >
//               {titleText}
...
// // //           initial="hidden"
// // //           animate="visible"
// // //           className="-rotate-12 filter drop-shadow-lg select-none absolute -left-10 hidden md:block bottom-0 lg:-translate-x-[5%] z-0"
// // //         >
// // //           <Image
// // //             src="/images/Eggplant.png"
// // //             alt="computer-repair"
