...
function Hero() {
  ...
  const titleVariants = {
    ...
    visible: {
      ...
      transition: {
        duration: 1.5,
        ease: [0.19, 1, 0.22, 1], // expo.out equivalent
    ...
    <section id="hero" className="relative" ref={heroRef}>
      <div className="min-h-screen w-full bg-gradient-to-br from-primary-50/50 via-white to-white overflow-hidden flex items-center justify-center">
        ...
        <motion.div
          ...
          style={{
            backgroundImage: `
              linear-gradient(to right, rgba(0, 102, 255, 0.09) 1px, transparent 1px),
              linear-gradient(to bottom, rgba(0, 102, 255, 0.09) 1px, transparent 1px),
              radial-gradient(circle 300px at 20% 20%, rgba(0, 102, 255, 0.15), transparent),
              radial-gradient(circle 500px at 80% 80%, rgba(0, 102, 255, 0.15), transparent),
              radial-gradient(circle 400px at 100% 40%, rgba(0, 255, 136, 0.05), transparent)
            `,
            backgroundSize:
        ...
        <div className="flex flex-col items-center gap-4 z-10 relative px-4 text-center max-w-4xl mx-auto w-full mb-32">
          <motion.h1
            className="text-primary-500 text-7xl md:text-[13vw] lg:text-[10vw] font-bold"
          ...
          <div className="flex flex-col items-center gap-2 -mt-4">
            <motion.p
              className="max-w-sm sm:max-w-md md:max-w-lg lg:max-w-4xl font-inter text-lg sm:text-xl md:text-2xl lg:text-3xl text-primary-600 font-semibold tracking-tight"
            ...
            <motion.p
              className="max-w-sm md:max-w-md lg:max-w-3xl text-neutral-700 font-inter text-base md:text-lg lg:text-xl font-medium text-center leading-relaxed"
        ...
        {/* Bottom Accent */}
        <div className="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-primary-200 via-secondary-400 to-primary-400 opacity-60"></div>
      </div>
    </section>
  );
}
