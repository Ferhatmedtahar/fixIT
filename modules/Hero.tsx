    ...
    <section id="hero" className="relative">
      <div className="min-h-screen w-full bg-gradient-to-br from-primary-50/50 via-white to-white overflow-hidden flex items-center justify-center">
        ...
        <Image
          ...
          height={300}
          loading="eager"
          className={`-rotate-12 left-image filter drop-shadow-lg select-none absolute -left-18 hidden md:block lg:bottom-0 lg:-translate-x-[5%] md:h-[400px] lg:h-[400px] xl:h-auto z-0`}
        />
        <Image
          src={`/images/usb.png`}
          alt="tech-tools"
        ...
        <div className="flex flex-col items-center gap-4 z-10 relative px-4 text-center max-w-4xl mx-auto w-full mb-32">
          ...
          <div className="flex flex-col items-center gap-2 -mt-4">
            <p className="max-w-sm sm:max-w-md md:max-w-lg lg:max-w-4xl yellow-subtitle font-inter text-lg sm:text-xl md:text-2xl lg:text-3xl text-primary-600 font-semibold tracking-tight">
              YOUR TECH PROBLEMS, OUR SOLUTIONS
            </p>
            <p className="max-w-sm md:max-w-md lg:max-w-3xl subtitle text-neutral-700 font-inter text-base md:text-lg lg:text-xl font-medium text-center leading-relaxed">
