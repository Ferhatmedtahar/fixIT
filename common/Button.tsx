...
//           "bg-[var(--background)] border-[var(--foreground)] text-[var(--foreground)] shadow-[2px_2px_0_var(--foreground)] hover:shadow-none hover:translate-x-[2px] hover:translate-y-[2px]",
//         secondary:
//           "bg-[var(--foreground)] border-[var(--foreground)] text-[var(--background)] shadow-[2px_2px_0_var(--background)] hover:shadow-none hover:translate-x-[2px] hover:translate-y-[2px]",
//         outline:
//           "bg-[var(--background)] border-[var(--foreground)] text-[var(--foreground)] shadow-[2px_2px_0_var(--foreground)] hover:shadow-none hover:translate-x-[2px] hover:translate-y-[2px]",
//         link: "bg-transparent text-[var(--foreground)] border-0 normal-case tracking-normal hover:underline",
//         ghost:
...
// // const buttonVariants = cva(
// //   "relative font-bold uppercase tracking-wider transition-all duration-300 flex items-center justify-center border-2",
// //   {
// //     variants: {
// //       variant: {
// //         default:
...
// //         outline:
// //           "bg-[var(--background)] border-[var(--foreground)] text-[var(--foreground)]",
// //         link: "bg-transparent text-[var(--foreground)] border-0 normal-case tracking-normal",
// //         ghost: "bg-transparent text-[var(--foreground)] border-0",
// //       },
// //       size: {
// //         sm: "px-4 py-2 text-xs sm:px-5 sm:py-2 sm:text-sm",
// //         md: "px-6 py-3 text-sm sm:px-7 sm:py-3 sm:text-base",
...
// // //       variant: {
// // //         default:
// // //           "bg-[var(--background)] border-[var(--foreground)] text-[var(--foreground)] hover:bg-[var(--foreground)] hover:text-[var(--background)]",
// // //         secondary:
// // //           "bg-[var(--foreground)] border-[var(--foreground)] text-[var(--background)] hover:bg-[var(--background)] hover:text-[var(--foreground)]",
// // //         outline:
// // //           "bg-[var(--background)] border-[var(--foreground)] text-[var(--foreground)] hover:border-[var(--foreground)]/50",
// // //         link: "bg-transparent text-[var(--foreground)] border-0 hover:underline normal-case tracking-normal",
// // //         ghost:
// // //           "bg-transparent text-[var(--foreground)] border-0 hover:bg-[var(--foreground)]/10",
// // //       },
// // //       size: {
...
// // // // const buttonVariants = cva(
// // // //   "relative font-bold uppercase tracking-wider transition-all duration-300 flex items-center justify-center border-2 border-[var(--foreground)]",
// // // //   {
// // // //     variants: {
// // // //       variant: {
// // // //         default:
...
// // // //         secondary:
// // // //           "bg-[var(--foreground)] text-[var(--background)] hover:bg-[var(--background)] hover:text-[var(--foreground)]",
// // // //         outline:
// // // //           "bg-[var(--background)] text-[var(--foreground)] hover:border-[var(--foreground)]/50",
// // // //         link: "bg-transparent text-[var(--foreground)] border-0 hover:underline normal-case tracking-normal",
// // // //         ghost:
// // // //           "bg-transparent text-[var(--foreground)] border-0 hover:bg-[var(--foreground)]/10",
// // // //       },
