...
const inputVariants = cva(
  "font-head rounded-lg shadow-sm transition-all duration-[350ms] w-full border-2 border-b-4 border-r-4 border-foreground focus:outline-hidden disabled:cursor-not-allowed disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
